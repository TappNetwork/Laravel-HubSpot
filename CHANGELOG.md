...
* Add public syncToHubSpot() method to HubspotContact trait by @scottgrayson in https://github.com/TappNetwork/Laravel-HubSpot/pull/32

**Full Changelog**: https://github.com/TappNetwork/Laravel-HubSpot/compare/v2.0.0...v2.0.1
